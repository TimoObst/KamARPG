...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FDamageTakenSignature, float, damageTaken, EKamElement, damageElement, bool, isCrit);
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "Unit Event Dispatcher")
		FDamageTakenSignature OnDamageTakenEvent;
